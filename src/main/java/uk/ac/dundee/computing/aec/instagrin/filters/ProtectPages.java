 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp","/index.jsp","/userProfile.jsp","/UsersPics.jsp"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
