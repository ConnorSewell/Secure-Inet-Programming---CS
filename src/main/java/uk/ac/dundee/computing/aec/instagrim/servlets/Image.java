...
public class Image extends HttpServlet {
     ...
     * Determines which type of image to display, e.g. single image, list of
     * images etc. response)
    ...
    /**
     * Gets the list of images for the users gallery
     *
     * @param User: The user whose images are being retrieved
     * @params request, response: The servlet request/response
     */
     ...
     * Displays an image
     *
     * @param type: The type of image e.g. jpeg, png etc
     * @param Image: A string representing the pictures uuid
    ...
    /**
     * Controls the process of uploading an image
     * @param: request/response of servlet
     */
